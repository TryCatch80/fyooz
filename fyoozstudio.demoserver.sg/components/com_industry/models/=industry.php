...
class IndustryModelIndustry extends JModelList
{
	...
	/**
	 * The list of other industry categories.
	 *
	 * @access    protected
	 * @var       array
	 */
	...
	public function getItems()
	{
		...
		for ($i = 0, $n = count($items); $i < $n; $i++)
		{
			...
			$this->tags->getItemTags('com_industry.industry', $item->id);
		}
	...
	protected function getListQuery()
	{
		...
		//	. ' CASE WHEN CHAR_LENGTH(c.alias) THEN CONCAT_WS(\':\', c.id, c.alias) ELSE c.id END AS catslug ');
			->from($db->quoteName('#__industry_details') . ' AS a')
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_industry')) && (!$user->authorise('core.edit', 'com_industry')))
		{
