 ...
 *
 * Subversion Details
 * $Date: 2014-09-22 21:33:52 -0500 (Mon, 22 Sep 2014) $
 * $Revision: 6289 $
 * $Author: bobsteen $
 *
...
if ($this->params->get('job_description_header', '0') == '1' && isset($this->posting_id)) {
    ...
    // $pdf->outCombo(JHTML::_('jobgrokapp.posting', $this->posting_id, true), $job_description);
    $pdf->outHeader(JHTML::_('jobgrokapp.posting', $this->posting_id, true));
...
if ($this->params->get('addresses', '1') == '1') {
    if ($this->params->get('addresses_current', '1') == '1') {
        ...
        if ($this->params->get('addresses_since') == '1')
            $pdf->outCombo($this->params->get('field_address_since', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_ADDRESS_SINCE')), $this->application->from_date);
    }
    ...
    if ($this->params->get('addresses_1', '1') == '1') {
        ...
        if ($this->params->get('addresses_since', '1') == '1')
            $pdf->outCombo($this->params->get('field_address_since', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_ADDRESS_SINCE')), $this->application->from_date1);
        if ($this->params->get('addresses_to', '1') == '1')
            $pdf->outCombo($this->params->get('field_address_to', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_ADDRESS_TO')), $this->application->to_date1);
    }
    ...
    if ($this->params->get('addresses_2', '1') == '1') {
        ...
        if ($this->params->get('addresses_since', '1') == '1')
            $pdf->outCombo($this->params->get('field_address_since', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_ADDRESS_SINCE')), $this->application->from_date2);
        if ($this->params->get('addresses_to', '1') == '1')
            $pdf->outCombo($this->params->get('field_address_to', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_ADDRESS_TO')), $this->application->to_date2);
    }
}
if ($this->params->get('education', '1') == '1') {
    if ($this->params->get('education_high', '1') == '1') {
        ...
        if ($this->params->get('education_diploma', '1') == '1')
            $pdf->outCombo($this->params->get('field_diploma', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_DIPLOMA')), $this->application->school_diploma == '1' ? JTEXT::_('YES') : JTEXT::_('NO'));
    }
    ...
    if ($this->params->get('education_undergrad', '1') == '1') {
        ...
        if ($this->params->get('education_diploma', '1') == '1')
            $pdf->outCombo($this->params->get('field_diploma', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_DIPLOMA')), $this->application->school_diploma1 == '1' ? JTEXT::_('YES') : JTEXT::_('NO'));
        if ($this->params->get('education_degree', '1') == '1')
            $pdf->outCombo($this->params->get('field_deg_cert_dip_long', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_DEG_CERT_DIP_LONG')), $this->application->diploma_text1);
    ...
    if ($this->params->get('education_grad', '1') == '1') {
        ...
        if ($this->params->get('education_diploma', '1') == '1')
            $pdf->outCombo($this->params->get('field_diploma', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_DIPLOMA')), $this->application->school_diploma2 == '1' ? JTEXT::_('YES') : JTEXT::_('NO'));
        if ($this->params->get('education_degree', '1') == '1')
            $pdf->outCombo($this->params->get('field_deg_cert_dip_long', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_DEG_CERT_DIP_LONG')), $this->application->diploma_text2);
        if ($this->params->get('education_study', '1') == '1')
    ...
    if ($this->params->get('education_other', '1') == '1') {
        ...
        if ($this->params->get('education_diploma', '1') == '1')
            $pdf->outCombo($this->params->get('field_diploma', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_DIPLOMA')), $this->application->school_diploma3 == '1' ? JTEXT::_('YES') : JTEXT::_('NO'));
        if ($this->params->get('education_degree', '1') == '1')
            $pdf->outCombo($this->params->get('field_deg_cert_dip_long', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_DEG_CERT_DIP_LONG')), $this->application->diploma_text3);
        if ($this->params->get('education_study', '1') == '1')
...
if ($this->params->get('employment_information', '1') == '1') {
    ...
    if ($this->params->get('employment_information_can_you_work', '1') == '1')
        $pdf->outcombo($this->params->get('field_you_can_work', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YOU_CAN_WORK')), ($this->application->weekends == '1' ? $this->params->get('field_weekends', JTEXT::_('WEEKENDS')) : '') . ' ' .
    ...
    if ($this->params->get('employment_information_available', '1') == '1')
        $pdf->outCombo($this->params->get('field_available', JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_AVAILABLE')), ($this->application->monday == '1' ? $this->params->get('field_monday_abbr', JText::_('MONDAY')) : '') . ' ' .
    ...
    if ($this->params->get('employment_information_question_1', '1') == '1') {
        ...
        $pdf->outValue($this->application->eligible == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
        ...
        $pdf->outValue($this->application->provideproof == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    }
    if ($this->params->get('employment_information_question_2', '1') == '1') {
        ...
        $pdf->outValue($this->application->worked_here_before == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    ...
    if ($this->params->get('employment_information_question_3', '1') == '1') {
        ...
        $pdf->outValue($this->application->job_desc_received == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    }
    if ($this->params->get('employment_information_question_4', '1') == '1') {
        ...
        $pdf->outValue($this->application->understand_reqs == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    ...
    if ($this->params->get('employment_information_question_5', '1') == '1') {
        ...
        $pdf->outValue($this->application->on_layoff == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    }
    if ($this->params->get('employment_information_question_6', '1') == '1') {
        ...
        $pdf->outValue($this->application->conf_agreement == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    ...
    if ($this->params->get('employment_information_question_7', '1') == '1') {
        ...
        $pdf->outValue($this->application->discharged == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    ...
    if ($this->params->get('employment_information_question_8', '1') == '1') {
        ...
        $pdf->outValue($this->application->convict == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    ...
    if ($this->params->get('employment_information_question_9', '1') == '1') {
        ...
        $pdf->outValue($this->application->family == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
...
if ($this->params->get('job_related_skills', '1') == '1') {
    ...
    if ($this->params->get('job_related_skills_q1', '1') == '1') {
        ...
        $pdf->outValue($this->application->driver_license == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    ...
    if ($this->params->get('job_related_skills_q2', '1') == '1') {
        ...
        $pdf->outValue($this->application->driving_offense == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
    ...
    if ($this->params->get('job_related_skills_q3', '1') == '1') {
        ...
        $pdf->outValue($this->application->dl_modified == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
...
if ($this->params->get('text_resume', '1') == '1') {
    ...
    $pdf->outValue($this->application->text_resume, true, true);
}
...
if ($this->params->get('agreement', '1') == '1') {
    ...
    if (isset($this->agreement)) {
        $pdf->outValue(strip_tags($this->agreement->introtext . " " . $this->agreement->fulltext, true, true));
    }
...
if ($this->params->get('display_custom_yes_no', '1') == '1') {
    ...
    $pdf->outValue($this->application->custom_yes_no == '1' ? JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_YES') : JTEXT::_('NO'), true, true);
}
...
$mysqlTime = JHTML::_('date', $timenow,$this->params->get('app_create_date_format',JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_MDY')));

$pdf->outCombo(JTEXT::_('COM_JOBGROKAPP_VIEWS_APPLICATION_TMPL_STATIC_RAW_CREATE_DATE'), $mysqlTime);
$pdf->output('foo.pdf');
?>
