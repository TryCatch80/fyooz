...
<h3><?php echo JTEXT::_('COM_JOBGROKAPP_VIEWS_DENIED_TMPL_DEFAULT_USER_DENIED_HEADER'); ?></h3>
<p><?php echo JTEXT::_('COM_JOBGROKAPP_VIEWS_DENIED_TMPL_DEFAULT_USER_DENIED'); ?></p>
<?php
    echo '<div>';
    $use_link =$this->params->get('registration_link','0');
    $menu_item = $this->params->get('registration_menu','');
    $link_text = $this->params->get('registration_text',JTEXT::_('COM_JOBGROKAPP_VIEWS_DENIED_TMPL_DEFAULT_TO_REGISTRATION_FORM'));
