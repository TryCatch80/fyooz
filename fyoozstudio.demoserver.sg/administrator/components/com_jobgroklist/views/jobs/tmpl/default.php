        ...
        <table class='table'>
            <thead>
                <tr>
                    ...
                    <th style="text-align: left;"><?php echo JTEXT::_('COM_JOBGROKLIST_ADMIN_JOBGROK_LOCATION'); ?></th>
                    ...
                    <th style="text-align: left;"><?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_JOB_TMPL_DEFAULT_POSITION'); ?></th>
                </tr>
            </thead>
            <?php
            $k = 0;
