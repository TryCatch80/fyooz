                ...
                <tr>
                    ...
                    <td width="100" align="right" class="key">
                        ...
                        <label for="location">
                            ...
                            <?php echo JTEXT::_('COM_JOBGROKLIST_ADMIN_JOBGROK_LOCATION'); ?>:
                    ...
                    <td>
                        ...
                        <span id="department_update"><?php echo $this->lists['location']; ?></span>
                ...
                <tr>
                    ...
                    <td width="100" align="right" class="key">
                        ...
                        <label for="alias">
                            ...
                            <?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_JOB_TMPL_DEFAULT_POSITION'); ?>:
                    ...
                    <td>
                        ...
                        <input class="text_area" type="text" name="position" id="position" size="32" maxlength="250" value="<?php if (isset($this->job->position)) echo $this->job->position;?>" />
