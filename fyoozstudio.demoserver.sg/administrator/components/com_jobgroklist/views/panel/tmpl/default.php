                ...
                <div class="span6">
                    <div class="well well-small">
                        <div id="cpanel">
                            ...
                            <?php /*?><a class="btn" href="index.php?option=com_jobgroklist&controller=posting">
                            ...
                            <?php /*?><a class="btn" href="index.php?option=com_jobgroklist&controller=company">
                            ...
                            <?php /*?><a class="btn" href="index.php?option=com_jobgroklist&controller=category">
