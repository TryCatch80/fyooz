...
/**
 * View class for a list of industries.
 *
 * @since  1.6
 */
class IndustryViewIndustries extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		IndustryHelper::addSubmenu('industries');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_INDUSTRY_MANAGER_INDUSTRIES'), 'address industry');

		if ($canDo->get('core.create') || (count($user->getAuthorisedCategories('com_industry', 'core.create'))) > 0)
		{
			JToolbarHelper::addNew('industry.add');
		}

		if (($canDo->get('core.edit')) || ($canDo->get('core.edit.own')))
		{
			JToolbarHelper::editList('industry.edit');
		}

		if ($canDo->get('core.edit.state'))
		{
			JToolbarHelper::publish('industries.publish', 'JTOOLBAR_PUBLISH', true);
			JToolbarHelper::unpublish('industries.unpublish', 'JTOOLBAR_UNPUBLISH', true);
			JToolbarHelper::archiveList('industries.archive');
			JToolbarHelper::checkin('industries.checkin');
		}
		...
		{
			JToolbarHelper::deleteList('', 'industries.delete', 'JTOOLBAR_EMPTY_TRASH');
		}
		...
		JHtmlSidebar::setAction('index.php?option=com_industry');
