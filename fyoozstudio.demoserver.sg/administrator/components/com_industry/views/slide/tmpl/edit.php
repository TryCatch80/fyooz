...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "slide.cancel" || document.formvalidator.isValid(document.getElementById("slide-form")))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_industry&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="slide-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
	        <div class="span9">
				...
				<?php echo $this->form->renderField('introtitle'); ?>
				<?php echo $this->form->renderField('introtext'); ?>
				<?php echo $this->form->renderField('images'); ?>
				<?php echo $this->form->renderField('readlink'); ?>
            </div>
		</div>
